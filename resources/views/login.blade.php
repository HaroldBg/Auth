...
<section class="py-10 bg-gray-50 sm:py-16 lg:py-24">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Connect your account</h2>
        </div>
                    ...
                    <form action="#" method="POST">
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="text-center">
                                <p class="text-base text-gray-600"><a href="{{route('pass_reset')}}" title=""
                                                                      class="font-medium text-blue-500 transition-all duration-200 hover:text-orange-600 hover:underline">
                                        forgot password?</a></p>
                            </div>
                            <div class="text-center">
                                <p class="text-base text-gray-600">No account ? <a href="{{route('register')}}" title=""
                                                                                   class="font-medium text-orange-500 transition-all duration-200 hover:text-orange-600 hover:underline">Sign
                                        up here</a></p>
                            </div>
                        </div>
                    </form>
